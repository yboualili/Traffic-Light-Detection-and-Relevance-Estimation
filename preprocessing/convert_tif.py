...
def convert_images(taget_path:str, label_path:str, data_path:str, split:str):
    """
    converting the images depending on the labels. If there is no label for an image, the image is not converted.
    """
    ...
    for _, img in enumerate(database.images):
        ...
        final_img.save(f"{taget_path}/{split}/{img_name}.jpg")
